export const ALL_COUNTRY_ISO_CODES = [
  ...
  { code: 'JP.TK', code3: 'JPN.TK', name: 'Tokyo', number: '392' },
  ...
  { code: 'GB', code3: 'GBR', name: 'Great-Britain', number: '826' },
  ...
  { code: 'EU', code3: 'EUR', name: 'Europe', number: '978' },
  { code: 'AP', code3: 'APAC', name: 'Asia-Pacific', number: '999' },
];
